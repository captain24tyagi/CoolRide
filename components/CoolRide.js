...
const CoolRide = () => {
  ...
  return (
    <div className="h-fit mx-auto z-20 md:mt-20 flex-col items-center justify-between max-w-7xl md:py-10 text-white flex overflow-x-scroll overflow-y-hidden">
