...
function Team() {
  return (
    <div className="h-screen mx-auto justify-between md:pt-20 items-center text-center md:mt-20 top-10 bottom-10 max-w-8xl">
      <h1 className="md:mt-20 mx-auto font-bold text-2xl top-10 mb-0 text-[#32CC8B]">Team</h1>
