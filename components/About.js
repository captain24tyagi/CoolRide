    ...
    <div className="md:h-screen mx-auto z-20 justify-between items-center max-w-7xl md:py-10 text-white lg:flex flex-row lg:mb-20 overflow-hidden">
      <div className="lg:flex flex-row max-w-fit items-center mt-10 md:pb-20">
        ...
        <motion.div
          ...
          className="mx-auto w-fit md:px-20"
        >
          <h2 className="text-2xl font-bold p-5 mt-10 pt-10 mx-auto text-[#32CC8B]">
            How it works
          </h2>
          ...
          <div className="p-5 w-[500px] flex flex-row items-center hover:shadow hover:shadow-black hover:text-[#32CC8B]">
            ...
            <div>
              <h3 className="text-md font-bold">Download CoolRide App</h3>
              <p className="text-sm">
          ...
          <div className="p-5 w-[500px] flex flex-row items-center hover:shadow hover:shadow-black  hover:text-[#32CC8B]">
            ...
            <div>
              <h3 className="text-md font-bold">Locate your CoolRide</h3>
              <p className="text-sm">
          ...
          <Link href="#scan">
            <div className="p-5 w-[500px] flex flex-row items-center hover:shadow hover:shadow-black  hover:text-[#32CC8B]">
              ...
              <div>
                <h3 className="text-md font-bold">Scan the QR Code</h3>
                <p className="text-sm">
          ...
          <div className="p-5 w-[500px] flex flex-row items-center hover:shadow hover:shadow-black hover:text-[#32CC8B]">
            ...
            <div>
              <h3 className="text-md font-bold">Enjoy Your CoolRide</h3>
              <p className="text-sm">
                Enjoy the CoolRide but remember to abide by all the traffic laws and parking
                policies.
              </p>
            </div>
          </div>
          ...
          <div className="p-5 w-[500px] flex flex-row items-center hover:shadow hover:shadow-black hover:text-[#32CC8B]">
            ...
            <div>
              <h3 className="text-md font-bold">End Your CoolRide</h3>
              <p className="text-sm">
                To end your ride, park the vehicle at a CoolRide station, lock it and click on the
                End button on your app.
              </p>
            </div>
          </div>
        </motion.div>
