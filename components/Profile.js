  ...
  return (
    <div className='h-screen text-left text-white mx-auto justify-between items-center max-w-7xl lg:flex flex-row'>
     <div className='items-center'>
      <h1 className='text-4xl font-sans px-20 py-10 text-white items-center max-w-[700px] tracking-wide'>
      <span className='font-bold text-[#32CC8B]'>
       {text}
      </span>
      <Cursor cursorColor="#FB923C"/>
      </h1>
      <p className='px-20 text-xl max-w-fit mx-auto'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla.</p>
    </div>
     <Image 
