...
const Contact = () => {
  ...
  return (
    <div className='h-screen justify-between items-center mx-auto w-fit mt-20 top-10 max-w-7xl pt-10'>
      <h1 className='mt-20 mx-auto font-bold text-2xl top-10 mb-0 text-center text-[#32CC8B]'>Contact</h1>
       ...
       <div className='flex flex-col'>
        <div className='flex flex-row m-10 mb-5 items-center'>
           ...
           <p className=' text-sm font-bold'>Cool Ride, Homefinders Estate, Ramapuram, Chennai- 600089</p> 
        </div>
        ...
        <h1 className='px-5 items-center justify-center m-10 text-center text-xl font-bold'>{write}<Cursor cursorColor='green'/></h1>
        ...
        >
          ...
          <button
           className="rounded-sm bg-[#32CC8B] p-2 text-black font-bold"
           type="submit"
          >
           Submit
          </button>
